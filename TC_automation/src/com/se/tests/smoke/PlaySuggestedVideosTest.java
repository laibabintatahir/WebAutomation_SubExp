...
public class PlaySuggestedVideosTest extends StudentLoginBase {

    public PlaySuggestedVideosTest() {
        this(false);
    }

    public PlaySuggestedVideosTest(boolean tearDownBrowserAfterEachTest) {

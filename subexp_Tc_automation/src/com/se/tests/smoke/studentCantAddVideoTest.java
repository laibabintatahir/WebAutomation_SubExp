...
public class studentCantAddVideoTest extends StudentLoginBase {

    public studentCantAddVideoTest() {
        this(false);
    }

    public studentCantAddVideoTest(boolean tearDownBrowserAfterEachTest) {
    ...
    public void verifyInteractiveVideoElements() {
        ...
        System.out.println("Student has no access to add video");
    }
